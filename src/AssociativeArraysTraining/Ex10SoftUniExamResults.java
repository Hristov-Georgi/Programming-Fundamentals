...
public class Ex10SoftUniExamResults {
    public static void main(String[] args) {
        ...
        studentsScoreMap.entrySet().forEach(entry -> System.out.printf("%s | %d%n", entry.getKey(), entry.getValue()));
        System.out.println("Submissions:");
        languageSubmissions.entrySet().forEach(entry -> System.out.println(entry.getKey()
        + " - " + entry.getValue()));
    }
}
//  System.out.println("Results:");
